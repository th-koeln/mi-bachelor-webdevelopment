...
\newcommand*\link[2]{%
  \hyperref[#1]{#2}\,\raisebox{-1pt}{\footnotesize\FourStarOpen}%
}
...
\rfoot{\thepage}
\lfoot{\changefont Modulhandbuch Medieninformatik Master Medieninformatik\\TH Köln // Institut für Informatik\\ \today}
