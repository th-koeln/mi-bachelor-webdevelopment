...
auch zukünftige technische Entwicklungen
...
Dabei lernen Sie im Kontext der Computergrafik Verfahrensweisen um den
algorithmischen Kern eines Problems zu identifizieren und können
Algorithmen entwerfen, verifizieren und bzgl. ihres Ressourcenbedarfs
bewerten.
...
Studierenden Problemstellungen im Anwendungskontext erkennen und sind
...
und Animation``, sowie''Cross-Platform Game Development mit Unity 3D" zu
...
\item
  können eine Methoden und Technologiewahl für einen Prpojektkontext
  fachlich begründen,
\item
