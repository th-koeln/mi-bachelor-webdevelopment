...
Definieren Sie eine CSS Regel mit der sich das Bild in der linken Spalte über die volle Breite des Eltern Elements erstreckt.
...
Mergen Sie zum Schluss den Branch aktuellen Branch in den `master`.