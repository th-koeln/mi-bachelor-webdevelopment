---
titel: CSS Transitions, SASS & CSS Layouts (WIP)
kuerzel: fd
verantwortlich: cn
typ: fd
pflicht: false
...
## Worum geht es?
Heute gibt es ein kurzes Recap des Themas Responsive Design. Wir schließen den Überblick über CSS mit CSS Transistions ab, die wir für geschmeidige Übergänge und zur Unterstüzung von Interaktionen nutzen können. Wir führen SASS ein, was uns auch zum Thema Build Chain und `npm script` bringt.
